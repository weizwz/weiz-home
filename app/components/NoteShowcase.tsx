...
export function NoteShowcase({
  ...
  const techStack = ['VitePress', 'Vue3', 'Cloudflare', 'Favicon API']
    ...
    <Section className='bg-gray-50' maxWidth='max-w-7xl'>
      <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center'>
        ...
        <div className='text-left space-y-8 lg:col-span-5'>
          {/* Tag */}
          <div className='inline-flex items-center px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-sm font-medium'>{subtitle}</div>

          {/* Title */}
          <h2 className='text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 tracking-tight leading-tight'>{title}</h2>

          {/* Description */}
          <p className='text-lg text-gray-600 leading-relaxed max-w-xl'>{description}</p>
