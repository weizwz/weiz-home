...
export function Recommended({ title = '推荐项目', subtitle = '看看我做了哪些有趣的项目' }: RecommendedProps) {
            ...
            {products.map((product) => (
              <div
                ...
                <Card className='p-6 md:p-8 h-full hover:shadow-xl transition-shadow duration-300'>
                  <div>
                    <h3 className='text-xl text-gray-500 text-center font-bold mb-1'>{product.subtitle}</h3>
                    <h3 className='text-xl text-center font-bold mb-4'>{product.title}</h3>
                    <a
                      href={product.link}
                      target='_blank'
                  ...
                  <div className={`mt-8 rounded-xl box-border ${product.border === false ? '' : 'border-5 border-gray-800'}`}>
                    ...
                    <div className='w-full aspect-8/5 rounded-md overflow-hidden'>
                      <img src={product.image} alt={product.imageAlt} className='w-full' />
                    </div>
                  </div>
                </Card>
              </div>
